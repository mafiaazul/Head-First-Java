...
public class QuizCardPlayer {
	...
	public class NextCardListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent ev) {
			...
			// set a flag for wether we're viewing a question or answer
			if (isShowAnswer) {
	...
	private void loadFile(File file) {
		...
		// called from the OpenMenuListener event handler, reads the fiel one line at a time
		// and tells the makCard() method to make a new card out of the line
